...
#ifndef __OSBOOT_7029_H__
#define __OSBOOT_7029_H__
...
#define SDMMC_STAR_ADDR                         SRAM_DRV_ADDR
#define NAND_STAR_ADDR                          SRAM_DRV_ADDR
#define ADFULAUNCHER_STAR_ADDR                  0xffff0208
                                                
/*  堆栈指针  */                                
#define SRAM_CPU0_SP_IRQ                        0xB407f000   //CPU0堆栈指针(IRQ)
#define SRAM_CPU0_SP_SYS                        0xB407f200   //CPU0堆栈指针(SYS)

#define SP_HEAD									0xb4079ff0
