...
#define USB_ENDPOINT_TYPE_ISOCHRONOUS               0x01 //Iso, No Synchronization
#define USB_ENDPOINT_TYPE_ISO_ASYCHRONOUS 		    0x05 //Iso, Asychronous
...
/* USB defined request codes see chapter 9 of the USB 1.0 specifcation for more information. */
...
#define USB_FEATURE_B_HNP_SUPPORT           	    0x0004
...
#define USB_REQUEST_BMREQUESTTYPE_TPYE_CLASS		0x20
...
#define USB_DEVICE_DESCRIPTOR_LENGTH	sizeof(USB_DEVICE_DESCRIPTOR)
...
typedef struct _USB_ENDPOINT_DESCRIPTOR {
    ...
    UCHAR bInterval;
    //UCHAR bRefresh;		//only for Audio Class
    //UCHAR bSynchAddress;	//only for Audio Class
} USB_ENDPOINT_DESCRIPTOR, *PUSB_ENDPOINT_DESCRIPTOR;
#define USB_ENDPOINT_DESCRIPTOR_LENGTH		sizeof(USB_ENDPOINT_DESCRIPTOR)
...
#define USB_INTERFACE_DESCRIPTOR_LENGTH		sizeof(USB_INTERFACE_DESCRIPTOR)
...
#define USB_DEVICE_QUALIFIER_DESCRIPTOR_LENGTH		sizeof(USB_DEVICE_QUALIFIER_DESCRIPTOR)	
...
#define USB_OTG_DESCRIPTOR_LENGTH		sizeof(USB_OTG_DESCRIPTOR)	
...
#define USB_STRING_DESCRIPTOR		sizeof(USB_STRING_DESCRIPTOR)	
...
typedef struct {
	...
	USB_ENDPOINT_DESCRIPTOR endpointout1;
	USB_ENDPOINT_DESCRIPTOR endpointin2;

} USB_ADFU_CONFIGALL;
#define USB_ADFU_CONFIGALL_LENGTH 32
