...
#define ACTS_MAX_PARTITION  12
#define HDCP_KEY_SIZE		308 	//bytes
#define SERIAL_NO_SIZE		16   	//bytes
#define PARTITION_TBL_SIZE	(ACTS_MAX_PARTITION * sizeof(partition_info_t))
...
#define UDISK_ACCESS        9

// logical partition numbers
#define ACTS_LOGIC_PARTN_1ST        1
#define ACTS_LOGIC_PARTN_RECOVERY   1
#define ACTS_LOGIC_PARTN_MISC       2
#define ACTS_LOGIC_PARTN_UDISK      10
#define ACTS_LOGIC_PARTN_SWSUSP     11
...
typedef struct
{
    partition_info_t partition_info[ACTS_MAX_PARTITION];            //分区信息表
