...
const struct owlxx_pinctrl_pin_desc atm7059_pads[NUM_PADS] = {
...
** mfp0_25_23
*/
static unsigned int  owlxx_mfp0_25_23_pads[] = {
	P_LCD0_D18,
};

static unsigned int  owlxx_mfp0_25_23_funcs[] = {
	OWLXX_MUX_NOR,
	OWLXX_MUX_SENS1,
	OWLXX_MUX_PWM2,
	OWLXX_MUX_PWM4,
...
** mfp0_22_20
*/
static unsigned int  owlxx_mfp0_22_20_pads[] = {
	P_ETH_CRS_DV,
};

static unsigned int  owlxx_mfp0_22_20_funcs[] = {
	OWLXX_MUX_ETH_RMII,
	OWLXX_MUX_ETH_SMII,
	OWLXX_MUX_SPI2,
	OWLXX_MUX_UART4,
...
** mfp0_18_16_eth_txd0
*/
static unsigned int  owlxx_mfp0_18_16_eth_txd0_pads[] = {
	P_ETH_TXD0,
};

static unsigned int  owlxx_mfp0_18_16_eth_txd0_funcs[] = {
	OWLXX_MUX_ETH_RMII,
	OWLXX_MUX_ETH_SMII,
	OWLXX_MUX_SPI2,
	OWLXX_MUX_UART6,
...
** mfp0_18_16_eth_txd1
*/
static unsigned int  owlxx_mfp0_18_16_eth_txd1_pads[] = {
	P_ETH_TXD1,
};

static unsigned int  owlxx_mfp0_18_16_eth_txd1_funcs[] = {
	OWLXX_MUX_ETH_RMII,
	OWLXX_MUX_ETH_SMII,
	OWLXX_MUX_SPI2,
	OWLXX_MUX_UART6,
...
*/
static unsigned int  owlxx_mfp0_15_13_rmii_txen_pads[] = {
	P_ETH_TXEN,
};

static unsigned int  owlxx_mfp0_15_13_rmii_txen_funcs[] = {
	OWLXX_MUX_ETH_RMII,
	OWLXX_MUX_UART2,
	OWLXX_MUX_SPI3,
	OWLXX_MUX_PWM0,
...
*/
static unsigned int  owlxx_mfp0_15_13_rmii_rxen_pads[] = {
	P_ETH_RXER,
};

static unsigned int  owlxx_mfp0_15_13_rmii_rxen_funcs[] = {
	OWLXX_MUX_ETH_RMII,
	OWLXX_MUX_UART2,
	OWLXX_MUX_SPI3,
	OWLXX_MUX_PWM1,
...
** mfp0_10_8_rmii_rxd1
*/
static unsigned int  owlxx_mfp0_10_8_rmii_rxd1_pads[] = {
	P_ETH_RXD1,
};

static unsigned int  owlxx_mfp0_10_8_rmii_rxd1_funcs[] = {
	OWLXX_MUX_ETH_RMII,
	OWLXX_MUX_UART2,
	OWLXX_MUX_SPI3,
	OWLXX_MUX_PWM2,
...
** mfp0_10_8_rmii_rxd0
*/
static unsigned int  owlxx_mfp0_10_8_rmii_rxd0_pads[] = {
	P_ETH_RXD0,
};

static unsigned int  owlxx_mfp0_10_8_rmii_rxd0_funcs[] = {
	OWLXX_MUX_ETH_RMII,
	OWLXX_MUX_UART2,
	OWLXX_MUX_SPI3,
	OWLXX_MUX_PWM3,
...
** mfp0_5
*/
static unsigned int  owlxx_mfp0_5_pads[] = {
	P_I2S_D0,
};

static unsigned int  owlxx_mfp0_5_funcs[] = {
	OWLXX_MUX_I2S0,
	OWLXX_MUX_NOR,
};
...
** mfp0_2_1_i2s0
*/
static unsigned int  owlxx_mfp0_2_1_i2s0_pads[] = {
	P_I2S_BCLK0,
};

static unsigned int  owlxx_mfp0_2_1_i2s0_funcs[] = {
	OWLXX_MUX_I2S0,
	OWLXX_MUX_NOR,
	OWLXX_MUX_PCM0,
};
...
** mfp0_2_1_i2s1
*/
static unsigned int  owlxx_mfp0_2_1_i2s1_pads[] = {
	P_I2S_BCLK1,
	P_I2S_LRCLK1,
	P_I2S_MCLK1,
};

static unsigned int  owlxx_mfp0_2_1_i2s1_funcs[] = {
	OWLXX_MUX_I2S1,
	OWLXX_MUX_NOR,
	OWLXX_MUX_PCM0,
};
...
** mfp0_0
*/
static unsigned int  owlxx_mfp0_0_pads[] = {
	P_I2S_D1,
};

static unsigned int  owlxx_mfp0_0_funcs[] = {
	OWLXX_MUX_I2S1,
	OWLXX_MUX_NOR,
};
...
** mfp1_31_29_ks_in2
*/
static unsigned int  owlxx_mfp1_31_29_ks_in2_pads[] = {
	P_KS_IN2,
};

static unsigned int  owlxx_mfp1_31_29_ks_in2_funcs[] = {
	OWLXX_MUX_KS,
	OWLXX_MUX_JTAG,
	OWLXX_MUX_NOR,
	OWLXX_MUX_PWM0,
...
** mfp1_31_29_ks_in0
*/
static unsigned int  owlxx_mfp1_31_29_ks_in0_pads[] = {
	P_KS_IN0,
};

static unsigned int  owlxx_mfp1_31_29_ks_in0_funcs[] = {
	OWLXX_MUX_KS,
	OWLXX_MUX_JTAG,
	OWLXX_MUX_NOR,
	OWLXX_MUX_PWM0,
...
** mfp1_22_21
*/
static unsigned int  owlxx_mfp1_22_21_pads[] = {
	P_LVDS_OEP,
	P_LVDS_OEN,
	P_LVDS_ODP,
	P_LVDS_ODN,
...
static unsigned int  owlxx_mfp1_22_21_funcs[] = {
	OWLXX_MUX_LVDS,
	OWLXX_MUX_TS,
	OWLXX_MUX_LCD0,
};
...
** mfp1_16_14
*/
static unsigned int  owlxx_mfp1_16_14_pads[] = {
	P_LCD0_D17,
};

static unsigned int  owlxx_mfp1_16_14_funcs[] = {
	OWLXX_MUX_NOR,
	OWLXX_MUX_SD0,
	OWLXX_MUX_SD1,
	OWLXX_MUX_PWM3,
...
** mfp1_13_12
*/
static unsigned int  owlxx_mfp1_13_12_pads[] = {
	P_DSI_DP3,
};

static unsigned int  owlxx_mfp1_13_12_funcs[] = {
	OWLXX_MUX_DSI,
	OWLXX_MUX_SD0,
	OWLXX_MUX_SD1,
	OWLXX_MUX_LCD0,
...
** mfp1_11_10
*/
static unsigned int  owlxx_mfp1_11_10_pads[] = {
	P_DSI_DN3,
};

static unsigned int  owlxx_mfp1_11_10_funcs[] = {
	OWLXX_MUX_DSI,
	OWLXX_MUX_RESERVED,
	OWLXX_MUX_SD1,
	OWLXX_MUX_LCD0,
...
** mfp1_6_5
*/
static unsigned int  owlxx_mfp1_6_5_pads[] = {
	P_LVDS_EEP,
	P_LVDS_EEN,
};

static unsigned int  owlxx_mfp1_6_5_funcs[] = {
	OWLXX_MUX_LVDS,
	OWLXX_MUX_NOR,
	OWLXX_MUX_TS,
	OWLXX_MUX_LCD0,
...
** mfp1_4_3
*/
static unsigned int  owlxx_mfp1_4_3_pads[] = {
	P_SPI0_SCLK,
	P_SPI0_MOSI,

};

static unsigned int  owlxx_mfp1_4_3_funcs[] = {
	OWLXX_MUX_SPI0,
	OWLXX_MUX_NOR,
	OWLXX_MUX_I2C3,
	OWLXX_MUX_PCM0,
...
** mfp1_2_0
*/
static unsigned int  owlxx_mfp1_2_0_pads[] = {
	P_SPI0_SS,
	P_SPI0_MISO,

};

static unsigned int  owlxx_mfp1_2_0_funcs[] = {
	OWLXX_MUX_SPI0,
	OWLXX_MUX_NOR,
	OWLXX_MUX_I2S1,
	OWLXX_MUX_PCM1,
...
** mfp2_30_29
*/
static unsigned int  owlxx_mfp2_30_29_pads[] = {
	P_DSI_DP1,
	P_DSI_CP,
	P_DSI_CN,
};

static unsigned int  owlxx_mfp2_30_29_funcs[] = {
	OWLXX_MUX_DSI,
	OWLXX_MUX_SD1,
	OWLXX_MUX_LCD0,
};
...
** mfp2_28_27
*/
static unsigned int  owlxx_mfp2_28_27_pads[] = {
	P_LVDS_EDP,
	P_LVDS_EDN,
	P_LVDS_ECP,
	P_LVDS_ECN,
...
static unsigned int  owlxx_mfp2_28_27_funcs[] = {
	OWLXX_MUX_LVDS,
	OWLXX_MUX_NOR,
	OWLXX_MUX_LCD0,
};
...
** mfp3_23_22
*/
static unsigned int  owlxx_mfp3_23_22_pads[] = {
	P_SENSOR0_CKOUT,
};

static unsigned int  owlxx_mfp3_23_22_funcs[] = {
	OWLXX_MUX_SENS0,
	OWLXX_MUX_NOR,
	OWLXX_MUX_SENS1,
	OWLXX_MUX_PWM1,
...
** mfp3_9_8
*/
static unsigned int  owlxx_mfp3_9_8_pads[] = {
	P_PCM1_CLK,
};

static unsigned int  owlxx_mfp3_9_8_funcs[] = {
	OWLXX_MUX_PCM1,
	OWLXX_MUX_SENS1,
	OWLXX_MUX_UART4,
	OWLXX_MUX_PWM5,
...
** 	mfp3_7_6
*/
static unsigned int  owlxx_mfp3_7_6_pads[] = {
	P_PCM1_SYNC,
};

static unsigned int  owlxx_mfp3_7_6_funcs[] = {
	OWLXX_MUX_PCM1,
	OWLXX_MUX_SENS1,
	OWLXX_MUX_UART6,
	OWLXX_MUX_I2C3,
...
** mfp3_8
*/
static unsigned int  owlxx_mfp3_5_4_pads[] = {
	P_PCM1_OUT,
};

static unsigned int  owlxx_mfp3_5_4_funcs[] = {
	OWLXX_MUX_PCM1,
	OWLXX_MUX_SENS1,
	OWLXX_MUX_UART6,
	OWLXX_MUX_I2C3,
...
** mfp3_3
*/
static unsigned int  owlxx_mfp3_3_pads[] = {
	P_DNAND_D0,
	P_DNAND_D1,
	P_DNAND_D2,
	P_DNAND_D3,
...
static unsigned int  owlxx_mfp3_3_funcs[] = {
	OWLXX_MUX_NAND,
	OWLXX_MUX_SD2,
};
...
** mfp3_2
*/
static unsigned int  owlxx_mfp3_2_pads[] = {
	P_DNAND_ALE,
	P_DNAND_CLE,
	P_DNAND_CEB0,
	P_DNAND_CEB1,
...
static unsigned int  owlxx_mfp3_2_funcs[] = {
	OWLXX_MUX_NAND,
	OWLXX_MUX_SPI2,
};
...
** mfp3_1_0_nand_ceb2
*/
static unsigned int  owlxx_mfp3_1_0_nand_ceb2_pads[] = {
	P_DNAND_CEB2,
};

static unsigned int  owlxx_mfp3_1_0_nand_ceb2_funcs[] = {
	OWLXX_MUX_NAND,
	OWLXX_MUX_PWM5,
};
...
** mfp3_1_0_nand_ceb3
*/
static unsigned int  owlxx_mfp3_1_0_nand_ceb3_pads[] = {
	P_DNAND_CEB3,
};

static unsigned int  owlxx_mfp3_1_0_nand_ceb3_funcs[] = {
	OWLXX_MUX_NAND,
	OWLXX_MUX_PWM4,
};
...
** dsi dummy group
*/
static unsigned int  owlxx_dsi_dummy_pads[] = {
	P_DSI_DN1,
};

static unsigned int  owlxx_dsi_dummy_funcs[] = {
	OWLXX_MUX_DSI,
};
...
**
*/
const struct owlxx_pinctrl_group atm7059_groups[] = {
...
const struct owlxx_pinctrl_func atm7059_functions[] = {
	...
	[OWLXX_MUX_PWM4] = FUNCTION(pwm4),
	[OWLXX_MUX_PWM5] = FUNCTION(pwm5),
...
struct owlxx_pinconf_pad_info atm7059_pad_tab[NUM_PADS] = {
