...
#define IRQ_ICCICR_ADDR		(OWLXX_PERIPH_BASE + 0x0100)
#define IRQ_ICCPMR_ADDR		(OWLXX_PERIPH_BASE + 0x0104)
#define IRQ_ICCIAD_ADDR		(OWLXX_PERIPH_BASE + 0x010C)
#define IRQ_ICCEOIR_ADDR	(OWLXX_PERIPH_BASE + 0x0110)
#define IRQ_ICDDCR_ADDR		(OWLXX_PERIPH_BASE + 0x1000)
#define IRQ_ICDISER_ADDR	(OWLXX_PERIPH_BASE + 0x1100)
#define IRQ_ICDICER_ADDR	(OWLXX_PERIPH_BASE + 0x1180)
#define IRQ_ICDIPR_ADDR		(OWLXX_PERIPH_BASE + 0x1400)
#define IRQ_ICDITARGET_ADDR	(OWLXX_PERIPH_BASE + 0x1800)
...
static inline void irq_enable_id(int id)
{
	...
	debug("bit(0x%x), off(0x%x) add(0x%x), val(0x%x)\n", bit, offset,
			IRQ_ICDISER_ADDR + offset, readl(IRQ_ICDISER_ADDR + offset));
}
