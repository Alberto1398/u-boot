 ...
 * so don't include kernel header files
 */
...
/* System */
#define P_TST_OUT		_PIN(32)

#define _FIRSTPAD		P_BT_D0
#define _LASTPAD		P_TST_OUT
#define NUM_PADS		(_LASTPAD - _FIRSTPAD + 1)

unsigned int atm7029a_num_pads = NUM_PADS;

#define PINCTRL_PIN(a, b) { .number = a, .name = b }
/* Pad names for the pinmux subsystem */
const struct owlxx_pinctrl_pin_desc atm7029a_pads[NUM_PADS] = {
	...
	PINCTRL_PIN(P_TST_OUT, "P_TST_OUT"),
};
...
/*
**
** all pinctrl groups of atm7029a board
**
*/
const struct owlxx_pinctrl_group atm7029a_groups[] = {
...
int atm7029a_num_groups = ARRAY_SIZE(atm7029a_groups);
...
const struct owlxx_pinctrl_func atm7029a_functions[] = {
...
int atm7029a_num_functions = ARRAY_SIZE(atm7029a_functions);
...
struct owlxx_pinconf_pad_info atm7029a_pad_tab[NUM_PADS] = {
