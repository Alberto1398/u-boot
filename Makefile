...
ifeq ($(shell if [ -d $(TOPDIR)/drivers/adfudec ]; then echo "y"; else echo "n"; fi;), y)
LIBS-$(CONFIG_OWLXX_UPGRADE) += drivers/adfudec/libadfudec.o
else
ifeq ($(CONFIG_OWLXX_UPGRADE),y)
PREBUILT_LIBS += $(TOPDIR)/../common/lib/libadfudec.a
endif
endif

LIBS-$(CONFIG_ANDROID_RECOVERY) += drivers/recovery/librecovery.o
...
$(obj)u-boot-dtb.img:	$(obj)u-boot-dtb.bin
		$(obj)tools/mkimage -A $(ARCH) -T firmware -C none \
		-O u-boot -a $(CONFIG_SYS_TEXT_BASE) \
...
ifeq ($(SOC),owl)
ifeq ($(CONFIG_OF_SEPARATE),y)
$(obj)u-boot-dtb-owl.img: $(obj)spl/u-boot-spl.bin $(obj)u-boot-dtb.img
		@echo $<
else
$(obj)u-boot-nodtb-owl.img: $(obj)spl/u-boot-spl-pad.img $(obj)u-boot.img
		cat $(obj)spl/u-boot-spl-pad.img $(obj)u-boot.img > $@
endif
endif
...
GEN_UBOOT = \
		cd $(LNDIR) && $(LD) $(LDFLAGS) $(LDFLAGS_$(@F)) \
			$(__OBJS) \
			--start-group $(__LIBS) $(PREBUILT_LIBS) --end-group $(PLATFORM_LIBS) \
