...
void board_init_r(gd_t *dummy1, ulong dummy2)
{
	...
	case BOOT_DEVICE_MMC2_2:
		...
		break;
#endif
#ifdef CONFIG_BOOT_SPL
#ifdef CONFIG_SPL_RAWNAND_SUPPORT
	case BOOT_DEVICE_RAWFLASH:
		spl_raw_nand_load_image();
		break;
#endif
#ifdef CONFIG_SPL_RAWMMC_SUPPORT
	case BOOT_DEVICE_RAWMMC:
		spl_rawmmc_load_image();
		break;
#endif
#endif
