...
static int abortboot_normal(int bootdelay)
{
	...
	char *s;
	s = getenv("owlbootcmdline");
	if (strcmp(s, SET_ENTER_BOOT_CMDLINE) == 0) {
		printf("\n");
		abort = 1;
		return abort;
	}
#endif
/**
 * use the new CONFIG to distinguish compile and enable.
 * adfu.o is also used by usb device type detect.
 */
#ifdef CONFIG_BOOT_ADFU_ENABLE
