...
#ifndef __ATM7059A_MMCBOOT_H
#define __ATM7059A_MMCBOOT_H

#include <configs/atm7059a_boot_spl.h>

#define CONFIG_SPL_RAWMMC_SUPPORT
#define CONFIG_OWLXX_MMC_BOOT  1
#define CONFIG_BOOTCOMMAND		CONFIG_MMC_BOOTCOMMAND
#define CONFIG_EXTRA_ENV_SETTINGS				\
	"devif=mmc\0"							\
	CONFIG_COMMON_ENV_SETTINGS				\
	"bootmenu_0=0) OTA Upgrade=setenv stdout serial; setenv mmcpart " 		\
		RECOVERY_MMC_DEV "; " CONFIG_BOOTCOMMAND "\0"
...
#define CONFIG_OWLXX_DISPLAY_HDMI
