...
#ifndef __CONFIG_S900VR_YS_2K_H__
#define __CONFIG_S900VR_YS_2K_H__
#include "s900_common.h"

#define CONFIG_IDENT_STRING	 "S900 YS_2K"
...
#define CONFIG_VIDEO_OWL_DE_S900
#define CONFIG_VIDEO_OWL_EDP
...
#define CONFIG_SYS_VIDEO_LOGO_MAX_SIZE		(15 * 1024 * 1024)
...
#define STATUS_LED_BIT		(114) /*GPIOD18*/
...
/* DWC3 */
#define CONFIG_USB_DWC3_OWL_S900
...
/* support back key to burn serial number */
#define CONFIG_KEY_ENTER_BURN_SN
#define KEY_BACK		158

#endif /* __CONFIG_S900VR_YS_2K_H__ */
