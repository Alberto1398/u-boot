...
#ifndef __ATM7059TC_BOOT_SPL_H
#define __ATM7059TC_BOOT_SPL_H
...
/* Defines for SPL */
#define CONFIG_SPL
#define CONFIG_SPL_LOAD_BASE		0xB4063800
#define CONFIG_SPL_AFINFO_SIZE		0x900		/* 2304B, afinfo */
#define CONFIG_SPL_TEXT_BASE		0xB4064100	/* after afinfo */
#define CONFIG_SPL_MAX_SIZE		    0x9C00

/* Defines for SP */
#define	CONFIG_SYS_INIT_SP_ADDR		0xB4070800
#define CONFIG_SPL_STACK		    CONFIG_SYS_INIT_SP_ADDR	/* 9.5KB, +8KB */
#define CONFIG_SPL_IRQ_STACK		0xB4062C00	/* 8KB */
