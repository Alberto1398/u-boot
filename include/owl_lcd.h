 ...
 */
 ...
 #ifndef __OWLXX_VIDEO_LCD_H__
 #define __OWLXX_VIDEO_LCD_H__
...
struct owlxx_lcd {
	...
	struct owlxx_fdt_gpio_state lcdpower_gpio;
	struct owlxx_fdt_gpio_state lcdpower2_gpio;
	struct owlxx_fdt_gpio_state lcdreset_gpio;
	struct owlxx_fdt_gpio_state lcdstandby_gpio;
	struct owlxx_regulator *lcdvcc_regulator;
