/*
 * owlxx_dss.h - OWL display driver
 *
...
extern const struct fb_videomode owlxx_mode_800_480;
extern const struct fb_videomode owlxx_mode_1280_720;

int owlxx_display_register(u32 display_id, struct display_ops *ops,
