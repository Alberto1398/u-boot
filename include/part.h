...
#define IF_TYPE_ACT_NANDBLK	10	/* add by Actions */
...
#define PART_TYPE_ACTAFI	0x06	/* add by Actions */
...
/* disk/part_actafi.c */
int get_partition_info_actafi(block_dev_desc_t * dev_desc, int part, disk_partition_t *info);
