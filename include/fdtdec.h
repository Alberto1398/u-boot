...
COMPAT_ACTIONS_BQ27441,
COMPAT_NCS8801_LVDS2EDP,
COMPAT_ACTIONS_OWLXX_I2C,
COMPAT_ACTIONS_OWLXX_FRAMEBUFFER,	/*Actions framebuffer*/
COMPAT_ACTIONS_OWLXX_PINCTRL,	/* owl pinctrl */
COMPAT_ACTIONS_OWLXX_PWM,	/*Actions PWM controller*/
COMPAT_ACTIONS_OWLXX_UART,	/* Actions UART console */
COMPAT_ACTIONS_OWLXX_SDMMC,	/* Actions SDMMC controller */
COMPAT_ACTIONS_OWLXX_LCD,	/* Actions LCD controller */
COMPAT_ACTIONS_OWLXX_ADCKEY,
COMPAT_ACTIONS_OWLXX_PWM_BACKLIGHT,	/*Actions PWM backlight driver*/
COMPAT_ACTIONS_OWLXX_GPIO,	/*Actions GPIO driver*/
COMPAT_ACTIONS_OWLXX_NAND,		/*Actions NAND*/
COMPAT_ACTIONS_OWLXX_DSI,	/* Actions DSI controller */
COMPAT_ACTIONS_OWLXX_USB3,        /* USB3 */

COMPAT_ACTIONS_OWLXX_POWER, 			/*Actions PMU*/
COMPAT_ACTIONS_SOFTCAP,
COMPAT_ACTIONS_AUDIO_SPEAKER,
COMPAT_ACTIONS_ATC260X,
COMPAT_ACTIONS_ATC260X_SWITCHLDO,
COMPAT_COUNT,
};
