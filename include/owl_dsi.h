...
struct owlxx_dsi {
	...
	struct owlxx_fdt_gpio_state dsipower_gpio;
	struct owlxx_fdt_gpio_state dsipower2_gpio;
	struct owlxx_fdt_gpio_state dsireset_gpio;
	
	struct owlxx_dsi_reg reg_val;
