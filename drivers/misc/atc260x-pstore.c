...
static const struct atc260x_pstore_fmt sc_atc2603c_pstore_fmt_tbl[] = {
	...
	[ATC260X_PSTORE_TAG_GAUGE_BAT_RES] = {
		.regs   = {ATC2603C_PMU_OC_INT_EN, ATC2603C_PMU_OC_INT_EN, ATC2603C_PMU_OC_INT_EN, ATC2603C_PMU_SYS_CTL9 },
...
U_BOOT_DRIVER(atc260x_pstore) = {
		.id = UCLASS_ROOT,
		.name = "atc260x_pstore",
		.of_match = atc260x_pstore_ids,
		.probe = atc260x_pstore_probe
};
