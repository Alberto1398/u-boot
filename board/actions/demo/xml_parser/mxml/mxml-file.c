...
long read(unsigned int fd, void *buf, size_t count)
{
	printf("funciton is null, read\n");
	return 0;
}

long write(unsigned int fd, void *buf, size_t count)
{
	printf("funciton is null, write\n");
	return 0;
}
 ...
 * using the mxml_mfree() function when you are done with it.  NULL is returned
